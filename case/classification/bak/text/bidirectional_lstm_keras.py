...
def get_model(shape, class_num):
    ...
    model.add(layers.Bidirectional(layers.LSTM(256, return_sequences=False), input_shape=(shape[0], shape[1])))
...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint('ckpt/bidirect_100.hdf5', save_best_only=True)
    type.summary()
    ...
    with open('nohup/bidirect_lstm_result.txt', 'w') as result:
